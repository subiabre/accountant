...
- [x] Add support to export data to JSON/CSV, e.g: `export file book1 book2`
- [x] Add support to import data from an accountant generated JSON file, e.g: `import file`
